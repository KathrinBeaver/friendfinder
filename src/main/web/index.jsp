    ...
    <div class="container">
        ...
        <div class="row header-info">
            <div class="col-sm-10 col-sm-offset-1 text-center">
                <h2 class="wow fadeIn" style="color: #74716e; margin-top: -25%">Добро пожаловать в Friend Finder!</h2>
                <br />
                <p class="lead wow fadeIn" data-wow-delay="0.5s" style="color: #79838f">Здесь вы найдете новых друзей и много интересных знакомств</p>
                <br />
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2 text-center margin-30 wow fadeIn" data-wow-delay="0.6s">
                ...
                <p class="lead">Приложение, ориентированное на поиск единомышленников, людей со схожими интересами и увлечениями. Friend Finder поможет познакомиться с любителями котиков или фанатом компьютерных игр всего за пару минут. Ищи, узнавай, дружи и получай удовольствие :) </p>
            </div>
        </div>
